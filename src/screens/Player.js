...
const Player = () => {
  ...
  return (
    <Screen>
    <Text style={styles.title}>Created by Hamza</Text>
      <View style={styles.container}>
        <View style={styles.audioCountContainer}>
          <View style={{ flexDirection: 'row' }}>
            {context.isPlayListRunning && (
              <>
                <Text style={{ fontWeight: 'bold' , color: color.FONT}}>From Playlist: </Text>
                <Text style={{ fontWeight: 'bold' , color: color.FONT}}>{context.activePlayList.title}</Text>
              </>
            )}
          </View>
        </View>
